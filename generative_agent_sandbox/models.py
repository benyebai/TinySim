...
ACTION_SPECS: tuple[ActionSpec, ...] = (
    ...
    ActionSpec(
        ...
        destination="Dorm",
        description="Wait for a promised reply from another person.",
    ),
    ActionSpec(
        id="send_message",
        label="send a message",
        destination="Dorm",
        description="Send a short message to follow up with another person.",
    ),
    ActionSpec(
        id="talk_with_jordan",
        label="talk with Jordan",
        destination="Campus",
        description="Have an in-person conversation with Jordan about the project.",
    ),
    ActionSpec(
...
ACTION_ALIASES = {
    ...
    "wait": "wait_for_reply",
    "wait_for_jordan": "wait_for_reply",
    "wait_for_jordan_message": "wait_for_reply",
    "jordan_message": "send_message",
    "message": "send_message",
    "send_jordan_message": "send_message",
    "send_message": "send_message",
    "talk": "talk_with_jordan",
    "talk_with_jordan": "talk_with_jordan",
    "ask_jordan": "talk_with_jordan",
    "ask_jordan_general": "talk_with_jordan",
    "ask_jordan_specific": "talk_with_jordan",
